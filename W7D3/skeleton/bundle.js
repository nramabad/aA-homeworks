...
document.addEventListener('DOMContentLoaded', function () {
  var store = _store_store__WEBPACK_IMPORTED_MODULE_2__["default"];
  debugger;
  ...
  window.fetchSearchGiphys = _util_api_util__WEBPACK_IMPORTED_MODULE_4__["fetchSearchGiphys"]; // ReactDOM.render(<Root store={store} />, root);
});
